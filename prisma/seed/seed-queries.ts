...
async function seedQueries() {
    ...
    const dummyQueries = [
        ...
        },
        {
            ...
            source: "LANDING_PAGE" as const, status: "SUBMITTED" as const, verified: false,
        ...
        },
        {
            ...
            source: "WHATSAPP" as const, status: "SUBMITTED" as const,
        ...
        },
        {
            ...
            source: "REFERRAL" as const, status: "SUBMITTED" as const, verified: false,
        ...
        },
        {
            ...
            source: "WEBSITE_FORM" as const, status: "SUBMITTED" as const,
