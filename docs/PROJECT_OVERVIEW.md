...
| Payments | `PAYMENT_PROVIDER`, `RAZORPAY_KEY_ID`, `RAZORPAY_KEY_SECRET`, `RAZORPAY_WEBHOOK_SECRET`, `NEXT_PUBLIC_RAZORPAY_KEY_ID`, `PAYU_KEY`, `PAYU_SALT`, `PAYU_BASE_URL`, `PAYU_API_URL` |
