...
const chatMessages = [
  { role: "user", text: "Plan a 7-day honeymoon in Himachal under ₹50,000." },
  {
    role: "bot",
    text: (
      <>
      ...
      <div className="screen-space grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <div className="relative z-10 after:absolute after:inset-0 after:-z-10 after:rounded-full after:bg-secondary-200/75 after:opacity-30 after:blur-xl hover:after:opacity-50 w-max px-3">
          ...
          >
            {[
              ...
              >
                ...
                <Text as="span" size="sm" className="text-neutral-300">
                  {item}
                </Text>
              </motion.li>
            ))}
          ...
          >
            ...
            >
              ...
              <div className="flex-1">
                <Text size="base" intent="inverse" weight="semibold" className="font-heading">
                  Avanti AI
                </Text>
                <Text size="xs" className="text-neutral-300">
                  Dreams Yatri Travel Assistant
                </Text>
              </div>
                  ...
                  >
                    {chatMessages[1].packages?.map((item, index) => (
                      <motion.li
                        key={index}
                        variants={staggerItem}
                        className="bg-white py-2.5 px-3.5 rounded-xl shadow-md shadow-neutral-200 ring-1 ring-inset ring-neutral-200 flex items-center"
                      >
                        <span className="flex-1 block space-y-0.5">
                          <Text size="xs" weight="semibold" className="font-heading">
                            {item.title}
                          </Text>
                          <Text size="sm" weight="bold" intent="brand" className="font-heading">
                            {item.price}
                          </Text>
                        </span>
