            ...
            <div className="flex gap-10 py-section-sm">
                ...
                <div className="flex-1">
                    ...
                    <div className="py-6 flex flex-col gap-8">
                        <TripDuration durationOptions={durationOptions} baseURL={`/package/${slug}`} durationSlug={duration} routeSlug={route} staySlug={stay} />

                        <DestinationRoutes routeSlug={route} routesOption={routesOption} baseUrl={`/package/${slug}`} durationSlug={duration} staySlug={stay} />
