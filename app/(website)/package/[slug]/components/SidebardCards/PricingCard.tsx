    ...
    return (
        <Card className='px-6 py-5'>
            <div className="flex items-center gap-4 mb-1.5">
                <Text size='sm' intent='muted' weight='medium' className='relative after:absolute after:w-full after:h-px after:bg-error-500 after:top-1/2 after:left-0 px-0.5'>{fmt(originalPrice)}</Text>
