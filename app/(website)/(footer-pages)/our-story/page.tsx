...
<PageHero
  ...
  subheading="Hassle free travel for everyone."
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col gap-8">
              ...
              <Reveal delay={200}>
                <div className="relative border-l-2 border-red-100 pl-6">
                  <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 rounded-full bg-red-200" />
                  <p className="text-gray-600 text-base leading-relaxed">
                    That night, shivering outside an unresponsive hotel, he didn't curse his luck. He pulled out a notebook and started writing down every single point where travel breaks — and what it would take to fix each one, permanently.
                  </p>
                </div>
              </Reveal>
