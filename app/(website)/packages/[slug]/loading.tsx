  ...
  return (
    <>
      ...
      <div className="screen-space pt-6 pb-10">
        ...
        {/* Tab bar skeleton — sticky just below the info band, mirroring the
            real tab bar (top ≈ info-band height, above the info band's z-205). */}
        <div
          className="sticky top-26.5 z-210 border-b border-(--border-muted) bg-white mt-3 mb-4"
          style={{
