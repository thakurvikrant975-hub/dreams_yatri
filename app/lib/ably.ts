...
export type VerificationCounts = { hotelsPending: number; cabsPending: number; bookingsUnconfirmed: number; packagesPending: number; hotelRequestsPending: number; leadRequestsPending: number; reopenRequestsPending: number };
