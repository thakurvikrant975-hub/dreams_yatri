...
export function Select({
    ...
    if (disabled) {
        ...
        triggerClasses +=
            ' text-error-800 ring-error-300 focus:ring-error-400 bg-error-500/15';
    } else if (success) {
        triggerClasses +=
            ' ring-neutral-400/60  focus:ring-success-400';
    } else {
        triggerClasses +=
    ...
    return (
        <div className={cn('relative', wrapperClassName)}>
            ...
            >
                ...
                >
                    <ChevronDownIcon className='size-4.5 text-neutral-500' />
                </span>
            </div>
            ...
            {open && !disabled && (
                <SelectContext.Provider value={{ value: selectedValue, setValue }}>
                    <div
                        ...
                        {...getFloatingProps()}
                        className="z-50 mt-1 w-full rounded-xl bg-white shadow-lg ring-1 ring-black/10 overflow-hidden"
                    >
