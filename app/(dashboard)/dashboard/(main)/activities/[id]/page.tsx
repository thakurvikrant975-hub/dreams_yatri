                    ...
                    <OverviewTab
                        activity={{
                            ...
                            location: activity.location ? {
                                ...
                                type:      activity.location.type as import("../../components/location/location.types").LocationType,
                                breadcrumb: [
                                    activity.location.name,
                                    (activity.location as any).state?.name,
                                    (activity.location as any).country?.name,
                                ].filter(Boolean).join(", "),
                                slug:      activity.location.slug,
                                latitude:  activity.location.latitude  != null ? Number(activity.location.latitude)  : null,
                                longitude: activity.location.longitude != null ? Number(activity.location.longitude) : null,
                            } : null,
