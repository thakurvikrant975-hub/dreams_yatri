            ...
            cell: (a) => (
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        {a.has_location && (a.location?.city || a.location?.state || a.location?.country) && (
                            <p className="text-xs text-muted-foreground/70 truncate max-w-45">
                                {[a.location?.city?.name, a.location?.state?.name, a.location?.country?.name].filter(Boolean).join(", ")}
                            </p>
                        )}
                    </div>
                </div>
