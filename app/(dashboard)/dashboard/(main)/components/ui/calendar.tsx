...
function Calendar({
  ...
  captionLayout = "label",
  buttonVariant: btnVariant = "ghost",
  locale,
  formatters,
  components,
  ...props
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background p-2 [--cell-size:--spacing(7)]",
        className,
      )}
      ...
      classNames={{
        ...
        button_previous: cn(
          buttonVariants({ variant: btnVariant }),
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "relative isolate z-10 flex size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0 leading-none font-normal",
