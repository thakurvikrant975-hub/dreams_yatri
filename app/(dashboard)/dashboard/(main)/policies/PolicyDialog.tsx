        ...
        <div className="space-y-5">
            ...
            <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground">
                    You can have multiple policies of the same type with different rules
                </p>
            </div>
...
function PointsStep() {
    ...
    function removePoint(i: number) {
        if (points.length === 1) { setPoints([""]); return; }
...
function PreviewStep() {
    const { stepData } = useMultiStepSheet();
...
function buildFormData(data: Record<string, unknown>, existing?: Policy): FormData {
...
export function EditPolicyDialog({
    ...
    return (
        <MultiStepSheet
            ...
            initialStepData={buildInitialData(policy)}
        >
