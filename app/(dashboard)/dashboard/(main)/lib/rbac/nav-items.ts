import {
  ...
  RotateCcw, Megaphone } from "lucide-react";
import {
...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Hotel Requests (New)", href: "/dashboard/hotel-requests-v2", icon: ClockCheck },
      { title: "Catalog Follow-up", href: "/dashboard/hotel-requests-v2/catalog", icon: Bed },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Lead Report", href: "/dashboard/lead-report", icon: FileSpreadsheet },
      { title: "Ads Performance", href: "/dashboard/ads-performance", icon: Megaphone },
      { title: "Landing pages", href: "/dashboard/landing-pages", icon: PlaneLanding },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Team Packages", href: "/dashboard/team-packages", icon: ShieldCheck },
      { title: "Team Hotel Requests", href: "/dashboard/team-hotel-requests", icon: Bed },
