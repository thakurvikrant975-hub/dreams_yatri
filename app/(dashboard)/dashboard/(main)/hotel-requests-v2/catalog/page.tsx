        ...
        <div className="space-y-6">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem><BreadcrumbLink href="/dashboard/hotel-requests-v2">Hotel Requests</BreadcrumbLink></BreadcrumbItem>
                    <BreadcrumbSeparator />
            ...
            {hotels.length === 0 ? (
                <div className="rounded-xl border border-dashboard-border bg-dashboard-surface p-6 text-center">
                    ...
                    <p className="text-xs text-dashboard-neutral mt-1">
                        ...
                        <Link href="/dashboard/hotel-requests-v2" className="underline underline-offset-2">
