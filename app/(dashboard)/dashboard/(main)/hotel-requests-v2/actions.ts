...
export type FillHotelInput = {
     ...
     * hotel card itself). fillPendingHotel reconciles this against mealPlan
     * regardless of what's here, so the two stay in sync even if only one of
     * the two fields was actually filled in — see reconcileMealsWithPlanText. */
    meals?: string[];
