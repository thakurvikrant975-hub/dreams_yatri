...
import { Plus, X, Loader2, Info, Tag, Search } from "lucide-react";
import { toast } from "sonner";
import { updatePackageBasic, updatePackageTags, updatePackageCategories } from "../../actions";
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <ImageField label="Cover Image" hint="Hero image · 1920×600"
              existingKey={pkg.cover_image} picks={coverPicks} onChange={setCoverPicks} />
          </div>
        ...
        <CardContent className="space-y-4">
          ...
          {(metaTitle || metaDesc) && (
            <div className="rounded-lg border p-3 bg-muted/20 space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-1">Preview</p>
