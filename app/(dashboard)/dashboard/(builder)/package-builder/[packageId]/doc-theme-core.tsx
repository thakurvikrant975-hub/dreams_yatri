// ─────────────────────────────────────────────────────────────────────────────
// Document templates & theming — data and pure functions only.
//
// Split out of doc-theme.tsx (which is "use client" for its Context/Provider)
// so server code — e.g. itinerary-settings/actions.ts's getItinerarySettings,
// which needs isTemplateId/DEFAULT_TEMPLATE to validate a DB value — can import
// this without hitting "Attempted to call a client function from the server".
// doc-theme.tsx re-exports everything here for existing client importers.
//
